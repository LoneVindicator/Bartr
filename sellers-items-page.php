...
<head>
    ...
    <link rel="stylesheet" href="sellers-items-page.css">
    <title>Item</title>
</head>
...
<body>
        ...
        <div class="main-content">
            ...
            <form id="selectItem" action="http://localhost/bartr/Bartr/my-app/src/item-page.php" method="get">
                ...
                <div class="main-content-content">
                    ...
                    <h1 class="page-title"><?php echo $sellerName?>'s Items</h1>
    ...
    <script src="sellers-items-page.js"></script>
